...
const LoginScreen = () => {
  ...
  return (
    <>
      <MobileLayout>
        <div className="w-full h-full justify-center items-center fixed flex flex-col gap-y-4 px-8 overflow-hidden">
          <div className="flex flex-col gap-y-1 h-fit text-left items-start justify-start">
            <h1 className="text-[24px] font-bold">Ayo Bergabung!</h1>
